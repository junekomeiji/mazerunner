...
public class Humanoid extends Character {
    ...
    public void loadCharacterAnimation() {
        ...
        for (int col = 0; col < walkAnimationFrames; col++) {
            characterDownAnimationFrames.add(new TextureRegion(this.texture, (col * frameWidth) + 4, 0, frameWidth, frameHeight));
        }
        ...
        for (int col = 0; col < walkAnimationFrames; col++) {
            characterLeftAnimationFrames.add(new TextureRegion(this.texture, (col * frameWidth) + 4, 32, frameWidth, frameHeight));
        }
        ...
        for (int col = 0; col < walkAnimationFrames; col++) {
            characterRightAnimationFrames.add(new TextureRegion(this.texture, (col * frameWidth) + 4, 64, frameWidth, frameHeight));
        }
        ...
        for (int col = 0; col < walkAnimationFrames; col++) {
            characterUpAnimationFrames.add(new TextureRegion(this.texture, (col * frameWidth) + 4, 96, frameWidth, frameHeight));
        }
